...
(function() {
  var app = angular.module('gogeoBrazilianCompanies.services', []);
      ...
      return {
        ...
        geosearch: function(latlng, zoom, query, callback) {
          ...
          var options = {
            ...
            buffer: pixelDist, // Define a buffer with haf marker size
        ...
        getSuggestion: function(query, points, currentQuery, callback) {
          ...
          return $http(params).then(
            function(result) {
              ...
              data.forEach(
                function(item) {
                  var text = item['fantasy_name'] || item['name'] || item['cnae_p_label'];
